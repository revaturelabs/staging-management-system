  ...
  ArrayList<Marketer> marketers = new ArrayList<>();
	...
	class AssociateP extends Associate{
	  ...
	  AssociateP(Associate a){
	    super(a.getId(), a.getCredential(), a.getName(), a.getPortfolioLink(), a.getBatch(), a.getProject(), a.isActive(), a.getLockedTo(),a.getSkills(), a.getJobs(),a.getCertifications());
	  ...
	  Associate getAssocaite(){
		  this.setActive();
	    return new Associate(getId(), getCredential(), getName(), getPortfolioLink(), getBatch(), getProject(), isActive(), getLockedTo(), getSkills(), getJobs(),getCertifications());
	  }
