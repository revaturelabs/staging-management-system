...
CREATE TABLE BATCHES (
  ...
  LOCATION_ID NUMBER,
  SALESFORCE_ID VARCHAR2(100) UNIQUE,
...
CREATE TABLE ASSOCIATES_STATUS (
  ...
  STATUS VARCHAR2(15)UNIQUE
);

CREATE SEQUENCE ASSOCIATE_STATUS_ID_SEQ;

INSERT INTO ASSOCIATES_STATUS VALUES (1, 'STAGING');
INSERT INTO ASSOCIATES_STATUS VALUES (2, 'PROJECT');
INSERT INTO ASSOCIATES_STATUS VALUES (3, 'BENCH');
INSERT INTO ASSOCIATES_STATUS VALUES (4, 'TRAINING');
...
CREATE TABLE ASSOCIATES (
  ...
  BATCH_ID NUMBER,
  PROJECT_ID NUMBER,
  ASSOCIATE_STATUS NUMBER,
  PORTFOLIO_STATUS NUMBER(1,0) DEFAULT 0,
  PANEL_STATUS VARCHAR2(10),
  ...
  CONSTRAINT FK_AssociateStatus FOREIGN KEY (ASSOCIATE_STATUS) REFERENCES ASSOCIATES_STATUS(ASSOCIATE_STATUS_ID),
