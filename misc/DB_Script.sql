...
ALTER TABLE ASSOCIATES ADD PROJECT_ID NUMBER;

ALTER TABLE ASSOCIATES ADD CONSTRAINT FK_AssociateProject FOREIGN KEY (PROJECT_ID) REFERENCES INTERNAL_PROJECT(PROJECT_ID);
