...
CREATE TABLE ASSOCIATES (
  ...
  BATCH_ID NUMBER,
  ASSOCIATE_ACTIVE NUMBER(1,0), --Disabled or not
  CLIENT_ID NUMBER, --ID of a priority client.
...
CREATE TABLE JOBS(
  ...
  JOB_PROJECTED_END_TIME TIMESTAMP,
  JOB_ACTUAL_END_TIME TIMESTAMP,
  JOB_BUYOUT_TIME TIMESTAMP,
